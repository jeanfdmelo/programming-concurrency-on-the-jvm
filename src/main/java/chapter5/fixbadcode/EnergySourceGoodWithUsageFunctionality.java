...
public class EnergySourceGoodWithUsageFunctionality {
    ...
    private EnergySourceGoodWithUsageFunctionality() {}
    ...
    public static EnergySourceGoodWithUsageFunctionality create() {
        final EnergySourceGoodWithUsageFunctionality energySource = new EnergySourceGoodWithUsageFunctionality();
        energySource.init();
        return energySource;
    }
